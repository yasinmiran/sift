...
const FOOTER = `<footer class="foot">${BYLINE}<a class="gh" href="${REPO_URL}" aria-label="source on GitHub">${OCTOCAT}</a></footer>`;
...
.foot{margin-top:4.5rem;display:flex;justify-content:space-between;align-items:center}
