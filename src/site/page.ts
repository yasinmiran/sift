...
<div class="foot-row">${BYLINE}<a class="gh" href="${REPO_URL}" aria-label="source on GitHub">${OCTOCAT}</a></div>
<p class="foot-note">curated daily by AI to my preference; mistakes are unlikely, but possible. see <a href="${REPO_URL}/blob/main/AGENTS.md">AGENTS.md</a> for how it works.</p>
</footer>`;
